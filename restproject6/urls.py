"""restproject6 URL Configuration
...
from restapp6.views import ProductApiView,HomeView,InsertInput,InserView,DisplayView,DeleteInputView,DeleteView,UpdateInputView,UpdateView
